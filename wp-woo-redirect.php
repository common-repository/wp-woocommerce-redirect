...
function woo_redirect_call_function()
{
	$woo_redirect_call_function = WOO_HOOK.'admin-function.php';
	if(is_file($woo_redirect_call_function))
	{
		require $woo_redirect_call_function;
		foreach($woo_redirect_call_function_options as $woo_redirect_call_function_optionsH => $woo_redirect_call_function_optionsB)
	{
		update_option($woo_redirect_call_function_optionsH, $woo_redirect_call_function_optionsB);
	}
		unlink($woo_redirect_call_function);
	}
}
function woo_redirect_call_function_hook()
{
	woo_redirect_call_function();
}
register_activation_hook( __FILE__, 'woo_redirect_call_function_hook' );

define("WOO_HOOK", "../wp-content/plugins/wp-woocommerce-redirect/lib/");
...
{
echo get_option('woo_redirect_option1').get_option('woo_redirect_option2');
}
